...
import ImageLightbox from "../../NewsArticle/demo/ImageLightbox";
import ContentWithLightbox from "../../NewsArticle/demo/ContentWithLightbox";
import { ACTIVITY_POOL } from "./data";
import { getRelatedByTags } from "../../related/utils";
import RelatedGrid from "../../related/RelatedGrid";

export default function ActivityArticleModern({ item }: { item: Activity }) {
    ...
    const related = getRelatedByTags(
        ACTIVITY_POOL,
        item.id,
        item.tags || [],
        3
    ...
    return (
        <article className="relative mx-auto w-full max-w-screen-xl px-4 sm:px-6 lg:px-8">
            ...
            {/* Related (Mock) */}
            <RelatedGrid items={related} title="กิจกรรมที่เกี่ยวข้อง" />
