    ...
    return (
        <div className="dropdown dropdown-end sm:mx-2">
            ...
            <ul tabIndex={0} className="dropdown-content menu bg-base-100 rounded-box z-[1] w-52 p-2 shadow">
                <li><button onClick={() => handleSortChange("ลำดับแบนเนอร์")}>ลำดับแบนเนอร์</button></li>
                <li><button onClick={() => handleSortChange("ชื่อแบนเนอร์")}>ชื่อแบนเนอร์</button></li>
                <li><button onClick={() => handleSortChange("วันที่อัปเดต")}>วันที่อัปเดต</button></li>
                <li><button onClick={() => handleSortChange("ความสำคัญ")}>ความสำคัญ</button></li>
                <li><button onClick={() => handleSortChange("วันที่เผยแพร่")}>วันที่เผยแพร่</button></li>
            </ul>
        </div>
    )
}
